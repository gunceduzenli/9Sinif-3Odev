...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/18zkLDi-tTgO-et0Hjz1CrEddhB43bGfglhQKLxIbLTs/edit?usp=sharing) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **0.0155+1.74x+-1.16x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif? **a hızın değişimini gösteren katsayı, b atış hızı olabilir.Negatif çıkmasının sebebi hızdaki negatif yönlü değişim olabilir.**

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? **Sabit değildir çünkü yüzey sürtünmesi de olabilir.** 

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) **b ve c değişebilir**
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1Xr4HithmrCmLF2CrS1LLF2hcycnUBAXC-bdk-YMBdOk/edit?usp=sharing) link veriniz.
...
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir?**1-2 ms** Konumdaki ölçüm hatam sizce kaç cm'dir? **0.1-0.2 cm**
